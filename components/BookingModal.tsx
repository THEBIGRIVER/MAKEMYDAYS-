...
const WHATSAPP_CONTACT = "917686924919"; 
...
const BookingModal: React.FC<BookingModalProps> = ({ event, onClose, onConfirm }) => {
  ...
  const handleWhatsAppBooking = useCallback(() => {
    ...
    const message = `Namaste ${MERCHANT_NAME}, I would like to confirm my resonance for:
        ...
        {modalState === 'selecting' && (
          <div className="animate-in fade-in slide-in-from-bottom-4">
            ...
            <div className="p-8 md:p-10 pt-6">
              ...
              <div className="flex flex-col">
                {/* WHATSAPP BOOKING BUTTON AS SOLE PRIMARY ACTION */}
                <button
                ...
                >
                  ...
                  <span className="font-black uppercase tracking-[0.25em] text-xs">Book with WhatsApp</span>
                </button>
              </div>
            </div>
          </div>
              ...
              {modalState === 'processing' && (
                <div className="py-10 flex flex-col items-center justify-center">
                   ...
                   <p className="text-slate-400 text-[10px] font-bold uppercase tracking-[0.3em] animate-pulse text-center">
                     Calibrating with WhatsApp Sanctuary...
                   </p>
                </div>
              )}
           </div>
